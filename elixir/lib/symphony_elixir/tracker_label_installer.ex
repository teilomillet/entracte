defmodule SymphonyElixir.TrackerLabelInstaller do
  @moduledoc """
  Loads runner config and asks the configured tracker adapter to install dispatch labels.
  """
  ...
  @spec install(keyword(), deps()) :: {:ok, [LabelInstallation.t()]} | {:error, term()}
  ...
  defp runtime_deps do
    %{
      ...
      install_labels: &Tracker.install_labels/1
    }
  end
