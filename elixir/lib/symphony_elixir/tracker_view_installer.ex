defmodule SymphonyElixir.TrackerViewInstaller do
  @moduledoc """
  Loads runner config and asks the configured tracker adapter to install saved views.
  """
  ...
  @spec install(keyword(), deps()) :: {:ok, [ViewInstallation.t()]} | {:error, term()}
  ...
  defp runtime_deps do
    %{
      ...
      install_views: &Tracker.install_views/1
    }
  end
